  ...
  return (
    <>
      <Navbar
        ...
        currentUserId={user?.id ?? ""} // <---using Optional Chaining dan Nullish Coalescing
      />
      ...
      <div className="min-h-screen bg-gray-100 pb-12 pt-6">
        <main className="max-w-3xl mx-auto p-4 mt-2">
          <div className="mb-6">
            <Link
              href="/offer-ride"
              className="w-full bg-linear-to-r from-indigo-600 to-blue-600 text-white font-bold p-4 rounded-xl mt-4 hover:shadow-lg hover:from-indigo-700 hover:to-blue-700 transition-all flex items-center justify-center gap-2 shadow-md"
            >
              <PlusCircle weight="bold" className="w-6 h-6" /> Tawarkan
              Tumpangan
            </Link>
          </div>
