...
import { Envelope, LockKey, Eye, EyeSlash, SignIn, CircleNotch } from '@phosphor-icons/react'
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        ...
        <h1 className="text-3xl font-black text-center text-blue-600 mb-2 tracking-tight">Mai-Milu</h1>
        <p className="text-center text-gray-500 mb-8 text-sm leading-relaxed">
          Bali Carpool Community. <br />
          Mari kurangi kemacetan dengan berbagi tumpangan!<br />
        ...
        <form onSubmit={handleSubmit(onSubmitForm)} className="flex flex-col gap-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <Link href="/forgot-password" className="text-xs text-blue-600 hover:text-blue-800 font-bold transition-colors">Lupa sandi?</Link>
            </div>
            <div className="relative">
        ...
        <p className="text-center text-sm text-gray-600 mt-8">
          Belum punya akun? <Link href="/register" className="text-blue-600 font-black hover:underline">Daftar di sini</Link>
        </p>
