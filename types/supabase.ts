  ...
  public: {
    Tables: {
      ...
      communities: {
        Row: {
          category:
            | Database["public"]["Enums"]["community_category_enum"]
            | null
          created_at: string
          id: string
      ...
      trips: {
        ...
        Relationships: [
          {
            foreignKeyName: "trips_community_id_fkey"
    ...
    Functions: {
      ...
      expire_past_rides: { Args: never; Returns: undefined }
    ...
    Enums: {
      ...
      community_category_enum:
        ...
        | "university"
        | "other"
      user_role: "pending" | "verified" | "admin"
